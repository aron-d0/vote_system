        ...
        <div class="bg-gray-800 text-gray-200 shadow-md sm:rounded-lg p-8">
            ...
            <div class="mt-8 bg-gray-700 border border-gray-600 p-6 rounded-lg shadow">
                ...
                <div class="flex flex-wrap gap-4">
                    <!-- Voter QR Button -->
                    <a href="<?php echo e(route('voter.verification')); ?>" 
                    ...
                    <!-- Quick Seed Button -->
                    <form action="<?php echo e(route('elections.store')); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marip\Herd\vote_system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>