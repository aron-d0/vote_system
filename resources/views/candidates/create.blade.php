    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Assign a candidate to an election and ballot position.</p>
            </div>
            ...
            <form action="{{ route('candidates.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" class="mt-1 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100" value="{{ old('name') }}" required>
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700">Save Candidate</button>
                </div>
            </form>
        </div>
    </div>
